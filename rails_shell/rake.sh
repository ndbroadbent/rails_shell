...
alias  rsp="zeus_if_possible test_rake spec"
alias  rts="zeus_if_possible test_rake test"

# Aliases for https://github.com/grosser/parallel_tests
alias rps="zeus_if_possible test_rake parallel:spec[$ACTUAL_CPU_CORES]"
alias rpl="zeus_if_possible test_rake parallel:load_schema[$ACTUAL_CPU_CORES]"
alias rpls="zeus_if_possible test_rake parallel:load_schema[$ACTUAL_CPU_CORES] parallel:spec[$ACTUAL_CPU_CORES]"
